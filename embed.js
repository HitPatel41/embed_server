(function() {
   ...
   // document.body.appendChild(appRoot);
    document.body.insertAdjacentElement('afterend', appRoot);
    console.log("App root element added to the DOM.");

    var cssLink = document.createElement('link');
    cssLink.rel = 'stylesheet';
    cssLink.href = 'https://admin.parth2success.com/popup/static/css/main.3f20eda3.css'; //Change this .css file path when new code updates
    ...
    reactDOMScript.onload = function() {
        ...
        appScript.src = 'https://admin.parth2success.com/popup/static/js/main.a4a3215d.js'; //Change this .js file path when new code updates
